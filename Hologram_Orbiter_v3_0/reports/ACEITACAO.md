...
| Bolso da porca M3 | 2.8 – 2.8 | 2.8 ±0,1 mm, torre sólida até z = +18 | ❌ | medido |
...
| Enrolamento por raios — aranha | 0 – 1 | 0 trechos com enrolamento ∉ {0,1} · 0 lâminas < 0,02 mm | ❌ | 16230 raios, passo 1.5 mm |
...
| Rosca sobrando acima da porca | 2.4 | ≥ 1 mm | ✅ | eixo de 14 mm acima da campânula; porca termina em Z = 191.6 |
...
| Massa por painel montado | 42.89 | ≤ 45 g | ✅ |  |
| Massa do rotor completo | 273.84 | ≤ 280 g | ✅ | inclui bateria (50 g medidos), fitas, ferragens e folga de eletrônica |
| Massa da aranha | 66.12 | ≤ 75 g (alvo) | ✅ | alvo revisto: os 55 g da spec são anteriores ao cubo Ø92 e à baia de 26 |
| Massa da tampa | 10.05 | ≤ 12 g (alvo) | ✅ | alvo revisto para Ø82 |
| Massa da base + torre | 321.03 | ≤ 330 g (alvo) | ✅ | peça estática; o custo é tempo de impressão |
...
| Malhas (arestas não-manifold no gerador) | 3 | 0 | ❌ | validação independente em reports/stl_validation.json |
| Base + brim cabe na mesa | 296.0 | ≤ 300 mm | ✅ | extensão medida na malha (com abas) 280.0 + 2 × 8 de brim |
| Piso da baia íntegro sob os furos da flange | 0.0 – 3.95 | sólido de Z = 0 até a flange inferior (12) | ❌ | 06-PENDENCIAS B3; furos só na flange superior: True |
...
| Suporte do ímã com dois pontos de fixação | 2 | ≥ 2 parafusos | ✅ | 06-PENDENCIAS B4; arco a 4.1 mm da campânula |
| Folga do suporte do ímã à campânula | 4.1 | ≥ 2 mm | ✅ | campânula medida em Ø28 |
...
**Resultado:** 42 de 46 critérios atendidos.

Reprovados: Bolso da porca M3, Enrolamento por raios — aranha, Malhas (arestas não-manifold no gerador), Piso da baia íntegro sob os furos da flange
